        ...
        <div class="d-lg-flex">
          ...
          <div class="ms-auto my-auto mt-lg-0 mt-4">
            <div class="ms-auto my-auto">
              <a href="{{ route('admin.contact-links.create') }}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Contact Link </a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <form class="d-inline" action="{{ route('admin.contact-links.destroy', $text->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
