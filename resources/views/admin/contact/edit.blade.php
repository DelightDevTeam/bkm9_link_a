...
<div class="row">
  <div class="col-12">
    <div class="container mb-3">
      <a class="btn btn-icon btn-2 btn-primary float-end me-5" href="{{ route('admin.contact-links.index') }}">
      ...
      <div class="row">
        <div class="col-lg-10 col-md-2 col-12 mx-auto">
          <div class="card">
            ...
            <div class="card-body">
              <form role="form" class="text-start" action="{{ route('admin.contact-links.update', $text->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="mb-3">
