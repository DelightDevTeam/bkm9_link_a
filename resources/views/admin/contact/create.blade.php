      ...
      <div class="row">
        <div class="col-lg-10 col-md-2 col-12 mx-auto">
          <div class="card">
            ...
            <div class="card-body">
              <form role="form" class="text-start" action="{{ route('admin.contact-links.store') }}" method="post">
                @csrf
                <div class="mb-3">
                    <label class="form-label text-dark fw-bold" for="inputEmail1">Contact Link</label>
